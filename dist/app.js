...
async function example() {
    ...
    const john = new Author_1.Author({ name: "John" });
    await john.save();
    const book1 = new Book_1.Book({ name: "book1", author: john });
    const book2 = new Book_1.Book({ name: "book2", author: john });
    await book1.save();
    await book2.save();
    john.books = [book1, book2];
    await john.save();
    const books = await Book_1.Book.find()
        .with("author", Author_1.Author)
        .all();
    console.log(books);
}
example();
...
___scope___.file("models/Author.js", function(exports, require, module, __filename, __dirname){

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const tslib_1 = require("tslib");
const fusedb_1 = require("fusedb");
class Author extends fusedb_1.Model {
}
tslib_1.__decorate([
    fusedb_1.Field(),
...
___scope___.file("models/Book.js", function(exports, require, module, __filename, __dirname){
...
class Book extends fusedb_1.Model {
}
tslib_1.__decorate([
    fusedb_1.Field(),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    fusedb_1.Field(),
    tslib_1.__metadata("design:type", typeof (_a = typeof Author_1.Author !== "undefined" && Author_1.Author) === "function" && _a || Object)
...
FuseBox.pkg("fusedb", {}, function(___scope___){
___scope___.file("index.js", function(exports, require, module, __filename, __dirname){
...
var FuseDB_1 = require("./FuseDB");
exports.FuseDB = FuseDB_1.FuseDB;
var index_1 = require("./validators/index");
exports.enableDefaultDecorators = index_1.enableDefaultDecorators;
...
class Model {
    constructor(props) {
        Utils_1.storeProp(this, "$fusedb", () => new FuseDB_1.FuseDB(this));
        if (props) {
            this.$fusedb.assignProps(props);
        }
    }
    async save() {
        return this.$fusedb.saveRecord();
    }
    async remove() {
    ...
    static find(opts) {
        const Cls = new this();
        return Cls.$fusedb.find(opts);
    }
}
exports.Model = Model;

});
___scope___.file("FuseDB.js", function(exports, require, module, __filename, __dirname){

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const FileAdapter_1 = require("./adapters/FileAdapter");
const os = require("os");
const path = require("path");
const ActiveQuery_1 = require("./ActiveQuery");
...
class FuseDB {
    ...
    static setup(opts) {
        exports.Config.adapter = opts.adapter;
    }
    getAdapter() {
        return exports.Config.adapter;
    }
    saveRecord() {
    ...
    find(opts) {
        return new ActiveQuery_1.ActiveQuery(opts, this);
    }
    async query(query) {
        const adapter = this.getAdapter();
        ...
        const subQuery = new SubQuery_1.SubQuery(this, query);
        await subQuery.map(response);
        return this.schema.mapValues(response);
    }
    async mapResponse(query, response) {
...
exports.FuseDB = FuseDB;
exports.Config = {
    adapter: FileAdapter_1.FileAdapter({
...
___scope___.file("adapters/FileAdapter.js", function(exports, require, module, __filename, __dirname){
...
class FileAdapterImpl {
    ...
    async update(collection, id, doc) {
        const db = await this.getConnection(collection);
        return new Promise((resolve, reject) => {
            db.update({ _id: id }, doc, (err, updated) => {
                if (err) {
                    return reject(err);
                }
...
exports.FileAdapterImpl = FileAdapterImpl;

});
___scope___.file("ActiveQuery.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("SubQuery.js", function(exports, require, module, __filename, __dirname){

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const realm_utils_1 = require("realm-utils");
class CollectionTask {
    constructor(field, withValue) {
        this.field = field;
...
class SubQuery {
    ...
    async map(values) {
        ...
        await realm_utils_1.each(this.conditions, (value, key) => this.onCondition(value, key));
        await realm_utils_1.each(this.collections, (task) => task.resolve());
        await this.assign();
    }
    async assign() {
...
const realm_utils_1 = require("realm-utils");
function storeProp(target, key, fn) {
    let data = target[key];
    if (!data) {
...
exports.storeProp = storeProp;
function ensureDatabaseCorrectValues(value) {
    if (value instanceof Model_1.Model) {
        return value._id;
    }
    else {
        if (realm_utils_1.utils.isArray(value)) {
            return value.map(i => ensureDatabaseCorrectValues(i));
        }
        if (realm_utils_1.utils.isPlainObject(value)) {
            let obj = {};
...
exports.ensureDatabaseCorrectValues = ensureDatabaseCorrectValues;

});
___scope___.file("Validator.js", function(exports, require, module, __filename, __dirname){
...
function Validator() {
    return function (Target) {
        ...
        Schema_1.Schema.validators.set(name, new Target());
    };
}
exports.Validator = Validator;

});
___scope___.file("Schema.js", function(exports, require, module, __filename, __dirname){
...
class Schema {
    ...
    addValidator(field, props, validator) {
        let info = this.validators.get(field);
        if (!info) {
            info = [];
    ...
    toDatabase(instance) {
        ...
        for (let key in this.collection) {
            if (key !== "_id") {
                ...
                values[key] = Utils_1.ensureDatabaseCorrectValues(value);
            }
        }
        return values;
    }
...
Schema.validators = new Map();
exports.Schema = Schema;

});
___scope___.file("decorators/FIeld.js", function(exports, require, module, __filename, __dirname){
...
function Field(type) {
    return function PropertyDecorator(target, propertyKey) {
        const schema = Utils_1.storeProp(target, "$schema", () => new Schema_1.Schema(target));
...
___scope___.file("decorators/Validate.js", function(exports, require, module, __filename, __dirname){
...
function Validate(data) {
    return function ValidateDecorator(target, propertyKey) {
        const schema = Utils_1.storeProp(target, "$schema", () => new Schema_1.Schema(target));
        for (let key in data) {
            const props = data[key];
            if (Schema_1.Schema.validators.has(key)) {
                schema.addValidator(propertyKey, props, Schema_1.Schema.validators.get(key));
            }
        }
    };
}
...
___scope___.file("validators/index.js", function(exports, require, module, __filename, __dirname){

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function enableDefaultDecorators() {
...
exports.enableDefaultDecorators = enableDefaultDecorators;

});
___scope___.file("validators/MinValidator.js", function(exports, require, module, __filename, __dirname){
...
let MinValidator = class MinValidator {
    validate(field, props, value) {
        const options = utils_1.extractValidatorPropeties(props);
...
___scope___.file("validators/utils.js", function(exports, require, module, __filename, __dirname){

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function extractValidatorPropeties(props, defaultMessage) {
    const result = {
        value: props,
...
exports.extractValidatorPropeties = extractValidatorPropeties;

});
___scope___.file("validators/MaxValidator.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("validators/FnValidator.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("validators/RegExpValidator.js", function(exports, require, module, __filename, __dirname){
...
const Validator_1 = require("../Validator");
const utils_1 = require("./utils");
let RegExpValidator = class RegExpValidator {
    validate(field, props, value) {
        const options = utils_1.extractValidatorPropeties(props);
...
RegExpValidator = tslib_1.__decorate([
    Validator_1.Validator()
], RegExpValidator);
exports.RegExpValidator = RegExpValidator;

});
___scope___.file("validators/EmailValidator.js", function(exports, require, module, __filename, __dirname){
...
FuseBox.pkg("nedb", {}, function(___scope___){
___scope___.file("index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/datastore.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/customUtils.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/model.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/executor.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/indexes.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/persistence.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/storage.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/cursor.js", function(exports, require, module, __filename, __dirname){
...
FuseBox.pkg("async", {}, function(___scope___){
___scope___.file("lib/async.js", function(exports, require, module, __filename, __dirname){
...
return ___scope___.entry = "lib/async.js";
});
FuseBox.pkg("binary-search-tree", {}, function(___scope___){
___scope___.file("index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/bst.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/avltree.js", function(exports, require, module, __filename, __dirname){
...
FuseBox.pkg("mkdirp", {}, function(___scope___){
___scope___.file("index.js", function(exports, require, module, __filename, __dirname){
...
FuseBox.pkg("fs-extra", {}, function(___scope___){
...
___scope___.file("lib/util/assign.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/fs/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/copy/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/copy/copy.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/copy/ncp.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/util/utimes.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/mkdirs/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/mkdirs/mkdirs.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/mkdirs/win32.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/mkdirs/mkdirs-sync.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/path-exists/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/copy-sync/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/copy-sync/copy-sync.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/copy-sync/copy-file-sync.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/util/buffer.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/remove/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/remove/rimraf.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/json/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/json/jsonfile.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/json/output-json.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/json/output-json-sync.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/move/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/move-sync/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/empty/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/ensure/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/ensure/file.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/ensure/link.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/ensure/symlink.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/ensure/symlink-paths.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/ensure/symlink-type.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/output/index.js", function(exports, require, module, __filename, __dirname){
...
FuseBox.pkg("universalify", {}, function(___scope___){
___scope___.file("index.js", function(exports, require, module, __filename, __dirname){
...
FuseBox.pkg("jsonfile", {}, function(___scope___){
___scope___.file("index.js", function(exports, require, module, __filename, __dirname){
...
FuseBox.pkg("shortid", {}, function(___scope___){
___scope___.file("index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/alphabet.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/random/random-from-seed.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/random/random-byte.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/build.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/is-valid.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("lib/util/cluster-worker-id.js", function(exports, require, module, __filename, __dirname){
